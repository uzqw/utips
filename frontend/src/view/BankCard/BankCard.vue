...
import BankIcons from "../../assets/icons/BankIcons";
const bankMap: Map<string, BankCardFace> = new Map([
    ['中信银行', {icon: BankIcons['中信银行'], bgColorClass: 'bank-bg-white'}],
    ['农业银行', {icon: BankIcons['农业银行'], bgColorClass: 'bank-bg-green'}],
    ['工商银行', {icon: BankIcons['工商银行'], bgColorClass: 'bank-bg-red'}],
    ['中国银行', {icon: BankIcons['中国银行'], bgColorClass: 'bank-bg-white'}],
    ['建设银行', {icon: BankIcons['建设银行'], bgColorClass: 'bank-bg-blue'}],
    ['招商银行', {icon: BankIcons['招商银行'], bgColorClass: 'bank-bg-zhaoshang'}],
    ['民生银行', {icon: BankIcons['民生银行'], bgColorClass: 'bank-bg-white'}],
    ['浦发银行', {icon: BankIcons['浦发银行'], bgColorClass: 'bank-bg-white'}],
    ['广发银行', {icon: BankIcons['广发银行'], bgColorClass: 'bank-bg-white'}],
    ['北京银行', {icon: BankIcons['北京银行'], bgColorClass: 'bank-bg-white'}],
    ['交通银行', {icon: BankIcons['交通银行'], bgColorClass: 'bank-bg-jiaotong'}],
    ['银行',    {icon: BankIcons['银行'], bgColorClass: 'bank-bg-white'}]
])
