    ...
    >
        <div class="statistic-user" v-if="showUserStatisticInfo">
            <div class="user-list" v-if="isAdminUser">
                <StatisticPanel :title="$tt('日记用户')">
                    <table>
                        <thead>
                        <tr>
                            <th class="">ID</th>
                            <th class="text-left">{{ $tt('用户名') }}</th>
                            <th class="">{{ $tt('最后访问时间') }}</th>
                            <th class="text-center hide-in-mobile">{{ $tt('注册时间') }}</th>
                            <th>{{ $tt('日记') }}</th>
                            <th>{{ $tt('码表') }}</th>
                            <th>{{ $tt('路书') }}</th>
                            <th>{{ $tt('同步次数') }}</th>
                ...
                <StatisticPanel :title="$tt('五笔码表用户')">
                    <table>
                        <thead>
                        <tr>
                            <th class="">ID</th>
            ...
            <!--用户日记数量柱状图-->
            <StatisticPanel :title="$tt('用户日记数量')">
