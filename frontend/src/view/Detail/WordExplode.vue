<template>
    <div class="word-explode">
        <div class="operation-list">
            <ButtonSmall class="mr-1" @click="selectNone">{{ $tt('取消选择') }}</ButtonSmall>
            <ButtonSmall class="mr-1" @click="selectAll">{{ $tt('全选') }}</ButtonSmall>
            <ButtonSmall class="mr-1" type="confirm" @click="copySelectedWords">{{ $tt('复制') }}</ButtonSmall>
        </div>
