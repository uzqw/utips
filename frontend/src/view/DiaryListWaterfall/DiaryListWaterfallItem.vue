<template>
    ...
    >
        ...
        <div class="content markdown small" v-if="props.diary.is_markdown" v-html="contentMarkDownHtml"></div>
        ...
        <div class="meta" :style="backgroundColor">
            ...
            <div class="category">{{ diaryCategoryName }}</div>
        </div>
...
import {DiaryEntityWaterfall} from "@/types/diary.ts";
...
const borderColor = computed<string>(() => {
    return `
        border-bottom-color: ${categoryStore.categoryObjectMap.get(props.diary.category).color};
        border-right-color: ${categoryStore.categoryObjectMap.get(props.diary.category).color};
    `
})
